...
::: {.callout-warning}
The Wokwi simulation above uses the **v3.x API** (`ledcAttach`). Our PlatformIO setup uses the **v2.x API** — see the note in [Lab 4](01_Lab4_PWM_Dimming.qmd) for details. Use the code below (v2.x) for your ESP32, not the code in the Wokwi diagram.
:::
...
Remember to set these settings in you `platformio.ini`:
```ini
